          ...
          <div class="modal-dialog">
            <div class="modal-content ">
              <div class="modal-header bg-primary">
					    <h3 class="modal-title text-center">Update Salary Settings</h3>
              </div>
    ...
    <div id="dialog" style="display: none"></div>
      <div class="card">
              <div class="card-header">
                <h5 class="m-0">EMPLOYEES LIST</h5>
              </div>
 ...
 $(function () {
    var datatable = 
            $('#loans_employee').DataTable({
                ...
                'ajax': {
                    'url':'loans_management',
                     'type': "POST",
                     "data": function (data){
                        data.action = "loans_employee";
                     }
                },
                'columns': [
                    ...
                    { data: 'salary_amount', "orderable": false  },
                    { data: 'loans', "orderable": false  },
  ...
  $(document).ready(function(){
    $('#modal_salary').on('show.bs.modal', function (e) {
        var rowid = $(e.relatedTarget).data('id');
        $.ajax({
            type : 'post',
            url : 'loans_management', //Here you will fetch records 
            data: {
                employee_id: rowid, action: "modal_salary"
            },
            success : function(data){
                $('#modal_salary .fetched-data').html(data);
            }
        });
     });
});
