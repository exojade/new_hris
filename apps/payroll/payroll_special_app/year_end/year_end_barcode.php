...
/* ::-webkit-scrollbar { 
  ...
  <section class="content-header">
      <h1>
        ...
        <form class="generic_form_trigger" style="float:right;" data-url="year_end" autocomplete="off">
        ...
        <div class="modal fade" id="modal_employee">
          <div class="modal-dialog modal-lg">
            <div class="modal-content ">
              ...
              <div class="modal-body">
                  <form class="generic_form_trigger" data-url="year_end" autocomplete="off">
                  ...
                  <tbody>
                    <?php $total = 0; foreach($payroll_actual as $row):
                      ...
                      if($row["deduction_type"] == "SEPARATED"):
                        ...
                        $accrued_bonus = $salary * $row["percentage"];
                      ...
                      $total = $total + ($accrued_bonus + $accrued_cash_gift);
                      ?>
                      <tr>
                          <td>
                            <form class="generic_form_trigger" style="display:inline;" data-url="year_end" autocomplete="off">
                          ...
                          <td class="text-right"><?php echo(to_peso($salary)); ?></td>
                          ...
                          <td class="text-right"><?php echo(to_peso($accrued_bonus)); ?></td>
                          <td class="text-right"><?php echo(to_peso($accrued_cash_gift)); ?></td>
                          <th class="text-right"><?php echo(to_peso($accrued_bonus+$accrued_cash_gift)); ?></th>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                  <tfoot>
...
$(document).ready(function(){
    $('#modal_leave').on('show.bs.modal', function (e) {
     ...
     $('#modal_employee').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'year_end', //Here you will fetch records 
            data: {
                employee_id: employee_id, 
                payroll_id: payroll_id, 
