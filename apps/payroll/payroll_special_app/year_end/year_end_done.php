  ...
  <section class="content-header">
    ...
    <div id="dialog" style="display: none"></div>
      <div class="card">
              ...
              <form class="generic_form_trigger" style="float:right; margin-right:10px;" data-url="year_end" autocomplete="off">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    foreach($payroll_actual as $row):
                      $total = $total + ($row["year_end_bonus"] + $row["accrued_cash_gift"]);
                      $percentage = "";
                      if($row["percentage"] != ""):
                      ...
                      <tr>
                          ...
                          <td class="text-right"><?php echo(to_peso($row["salary"])); ?></a></td>
                          <td class="text-right"><?php echo(to_peso($row["cash_gift"])); ?></td>
                          <td class="text-right"><?php echo($row["length_of_service"]); ?></td>
                          <td class="text-right"><?php echo($percentage); ?></td>
                          <td class="text-right"><?php echo(to_peso($row["year_end_bonus"])); ?></td>
                          <td class="text-right"><?php echo(to_peso($row["accrued_cash_gift"])); ?></td>
                          <td class="text-right"><?php echo(to_peso($row["year_end_bonus"] + $row["accrued_cash_gift"])); ?></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                  <tfoot>
