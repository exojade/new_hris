                    ...
                    <?php foreach($payroll_group as $row): ?>
                      <tr>
                        ...
                        <?php if($row["payroll_status"] != "done"): ?>
                          <td><a href="year_end?action=barcode&barcode=<?php echo($row["barcode"]); ?>"><?php echo($row["barcode"]); ?></a></td>
                        <?php else: ?>
                          <td><a href="year_end?action=done&barcode=<?php echo($row["barcode"]); ?>"><?php echo($row["barcode"]); ?></a></td>
                        <?php endif; ?>
