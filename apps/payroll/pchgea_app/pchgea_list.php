...
/* ::-webkit-scrollbar { 
  ...
  <section class="content-header">
    ...
    <div class="modal fade" id="modal_pchgea">
...
<script>
 $(function () {
  ...
  $(document).ready(function(){
    $('#modal_pchgea').on('show.bs.modal', function (e) {
        var rowid = $(e.relatedTarget).data('id');
        $.ajax({
            type : 'post',
            url : 'pchgea', //Here you will fetch records 
            data: {
                employee_id: rowid, action: "modal_pchgea"
            },
            success : function(data){
                $('#modal_pchgea .fetched-data').html(data);
            }
        });
     });
});
