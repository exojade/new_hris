(function ($) {
  ...
  var dzChartlist = (function () {
    ...
    var customerMap = function () {
      ...
      var chart = new ApexCharts(
        document.querySelector("#customerMap"),
        options
      );
      chart.render();
    };
    ...
    var customerMap2 = function () {
      ...
      var chart = new ApexCharts(
        document.querySelector("#customerMap2"),
        options
      );
      chart.render();
    };
    ...
    var customerMap3 = function () {
      ...
      var chart = new ApexCharts(
        document.querySelector("#customerMap3"),
        options
      );
      chart.render();
    };
    ...
    var widgetChart2 = function () {
      ...
      var chartBar1 = new ApexCharts(
        document.querySelector("#widgetChart2"),
        options
      );
      chartBar1.render();
    };
    var widgetChart3 = function () {
      ...
      var chartBar1 = new ApexCharts(
        document.querySelector("#widgetChart3"),
        options
      );
      chartBar1.render();
    };
