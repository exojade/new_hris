...
class GoogleClient
{
 protected $client_id = '538691118774-50b5ak993tc510dlrmoishso1pi8qv2q.apps.googleusercontent.com';
    ...
    public function __construct()
    {
        ...
        if (isset($_SESSION["hris"]['GOOGLE_ACCESS_TOKEN'])) {
            $this->client->setAccessToken($_SESSION["hris"]['GOOGLE_ACCESS_TOKEN']);
            //  Checking current access token is expired
            if($this->client->isAccessTokenExpired()){
                // Refresh access token and add it into session
                $client->refreshToken($_SESSION["hris"]['GOOGLE_REFRESH_TOKEN']);
                $access_token = $this->client->getAccessToken();
                $_SESSION["hris"]['GOOGLE_ACCESS_TOKEN'] = $access_token;
            }
        }
    }
    ...
    public function authenticate($code)
    {
        ...
        $_SESSION["hris_system"]['GOOGLE_ACCESS_TOKEN'] = $this->client->getAccessToken();
        $_SESSION["hris_system"]['GOOGLE_REFRESH_TOKEN'] =  $this->client->getRefreshToken();
    }
