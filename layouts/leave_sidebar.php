<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link" class="text-center">
      ...
      <span class="brand-text font-weight-light">HRIS Leave</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
  ...
  <li class="nav-item">
      <a href="apply_leave" class="nav-link <?php echo ($lastWord == 'apply_leave') ? 'active' : ''; ?>">
  ...
  <li class="nav-item">
      <a href="leave_summary" class="nav-link <?php echo ($lastWord == 'leave_summary') ? 'active' : ''; ?>">
  ...
  <li class="nav-item">
      <a href="#" class="nav-link <?php echo ($lastWord == 'approve_leave') ? 'active' : ''; ?>">
  ...
  <li class="nav-item">
      <a href="#" class="nav-link <?php echo ($lastWord == 'leave_ledger') ? 'active' : ''; ?>">
